...
const ERROR_MESSAGES = {
  ...
  ip_suspended:   ()  => 'PRONOTE a suspendu l\'adresse IP de ce réseau — trop '
                       + 'd\'authentifications. Les collectes sont gelées plusieurs '
                       + 'heures : réessayer prolongerait la sanction.',
